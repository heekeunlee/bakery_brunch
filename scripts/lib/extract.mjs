...
const STOPWORDS = new Set([
  ...
  // 제목에서 카페를 꾸미는 말들. 그대로 두면 같은 이름의 실제 가게에 정확히
  // 매칭돼 통과한다("분위기 좋은 카페" → 강화군의 '좋은', "바다뷰" → 기장의 '바다").
  // 글마다 등장하니 언급수도 압도적이어서 상위를 독식한다.
  '좋은', '예쁜', '이쁜', '멋진', '조용한', '한적한', '아늑한', '넓은', '유명한',
  '새로운', '힙한', '작은', '바다', '숲속', '산속', '강변', '노을', '야경',
]);
